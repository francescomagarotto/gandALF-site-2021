      ...
      <main className={"flex-fill col-md-8 offset-md-2 col-sm-12"}>
        ...
        <section>
          ...
          <dl className="grid-dl">
            ...
            <dd><del>June 23, 2021</del> June 30, 2021</dd>
        ...
        <section>
          ...
          <p>
            ...
            <b>
              ...
              Computer Science (
              <a href="https://lmcs.episciences.org/">
                https://lmcs.episciences.org/
              </a>
              )
            </b>
            . The previous editions of GandALF already led to special issues of
            the International Journal of Foundations of Computer Science
            (GandALF 2010), Theoretical Computer Science (GandALF 2011 and
            2012), Information and Computation (GandALF 2013, 2014, 2016, 2017,
            2019 and 2020), and Acta Informatica (GandALF 2015).
          </p>
        </section>
        <section>
          <h3>Submission</h3>
          <p>
            Submitted papers should not exceed 14 pages (excluding references
            and clearly marked appendices) using EPTCS format(please use the
            LaTeX style provided at  
            <a href="http://style.eptcs.org"> http://style.eptcs.org</a>), be
            unpublished and contain original research. For papers reporting
            experimental results, authors are encouraged to make their data
            available with their submission. Submissions must be in PDF format
            and will be handled via the EasyChair Conference system at the
            following address:{" "}
            <a
              href="https://www.easychair.org/conferences/?conf=gandalf2021
"
            >
              Gandalf 2021 Conference EasyChair
            </a>
          </p>
        </section>
      </main>
