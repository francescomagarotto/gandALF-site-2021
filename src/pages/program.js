  ...
  return (
    <Layout>
      ...
      <main className={"flex-fill col-md-8 offset-md-2 col-sm-12"}>
        ...
        <section>
        <p>The proceedings GandALF 2021 have been published as EPTCS 346. 
        You can find the full proceedings at the{" "} 
        <a href="http://dx.doi.org/10.4204/EPTCS.346">
            EPTCS website
        </a>
        .</p>
        <p>
        The{" "}
        <a href="/gandalf2021.pdf">
        Conference Booklet
        </a>
        {" "}contains the detailed program and other useful 
        information to attend GandALF and OVERLAY in person.
        </p>
        </section>
        <section>
          <h2>Schedule</h2>
